...
const SpeechRecognitionButton = forwardRef<SpeechRecognitionRef, SpeechRecognitionProps>(({
  ...
  return (
    <Button
      ...
      className={`rounded-md rounded-bl-lg p-[7px] h-fit dark:border-zinc-700 hover:dark:bg-zinc-900 hover:bg-zinc-200 text-gray-700 dark:text-gray-300 ${isListening ? 'bg-red-100 text-red-500 hover:bg-red-200 dark:bg-red-900/30 dark:text-red-400 dark:hover:bg-red-800/30' : ''}`}
      type="button"
